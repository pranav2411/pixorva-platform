    ...
    <div className={`min-h-screen bg-white text-black ${inter.className} flex flex-col`}>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left space-y-6">
            ...
            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl" style={{ color: "rgba(255,255,255,0.95)" }}>
              &ldquo;I perform semantic keyword audits and write organic blog posts that rank #1 on search engines.&rdquo;
            </p>
            ...
            <div className="space-y-4 pt-4 max-w-md">
              ...
              >
                {loading ? 'Processing Transaction...' : '⚡ Hire GORDON NOW'}
              </button>
            </div>
          </div>
      ...
      <section className="bg-white border-b-4 border-black py-10 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            ...
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">CTR UPLIFT INDEX</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b-4 border-black py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            {["We write articles but none of them show up on Google search results.","Finding high-value, low-competition keywords is too technical.","Our organic traffic is flat and paid ads are too expensive."].map((pt, idx) => (
              <div 
                key={idx} 
      ...
      <section className="bg-white border-b-4 border-black py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium">
            Gordon is your AI SEO Blog Writer, a tireless teammate who lives inside your workspace channels.
        ...
        <div className="max-w-5xl mx-auto space-y-20">
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <h3 className={`text-3xl uppercase font-black leading-none ${oswald.className}`}>
                  SEMANTIC KEYWORD AUDITS
                </h3>
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Gordon performs database queries on search keywords to prioritize low-difficulty, high-volume search parameters.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Keyword difficulty analysis</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>High search intent targeting</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Avoids saturated search terms</span>
                    </li>
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Gordon structures blog posts with correct header sequences, semantic keyword insertion, and perfect meta structures.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Auto-drafts complete articles</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Structures H1/H2 header hierarchies</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Calculates optimal reading times</span>
                    </li>
            ...
            <h4 className="font-black text-xs uppercase text-green-600 border-b-2 border-black pb-2">Blog Outlines</h4>
            <div className="text-[10px] font-bold text-gray-500 pt-3 leading-relaxed">
              H1: How AI Employees Optimize Payroll Overhead<br />
              ✓ Meta description generated (152 characters)
            </div>
          </div>
              </div>
            </div>
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black text-center">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <p className="text-xs text-gray-500 font-bold uppercase max-w-xl mx-auto">
            Up and running in minutes. Gordon handles the operational busywork so you can spend your day on what matters.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
              ...
              <p className="text-xs text-gray-500 font-medium leading-relaxed">
                Link Gordon to your Slack, email, or repository in a couple of clicks. Setup is fully automated.
              </p>
            </div>
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {[
              { q: "What exactly can Gordon do?", a: "I perform semantic keyword audits and write organic blog posts that rank #1 on search engines. She executes autonomous steps based on your triggers." },
      ...
      <section className="bg-gray-50 py-16 border-b-4 border-black text-center overflow-hidden">
        <div className="max-w-5xl mx-auto space-y-10 px-6">
          <h2 className={`text-3xl md:text-5xl uppercase font-black leading-none ${oswald.className}`}>
            Gordon Loves to work with a team
          </h2>
        </div>
      ...
      <section className="bg-white py-16 px-6 text-center border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-8 border-4 border-black p-10 rounded-3xl bg-yellow-50 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
          ...
          <p className="text-lg md:text-xl font-bold text-gray-800 leading-snug relative z-10 max-w-xl mx-auto">
            Gordon could have indexed {(seconds * 0.05).toFixed(2)} high-value search keywords, generated {(seconds * 0.025).toFixed(2)} organic blog post drafts, and optimized {(seconds * 0.04).toFixed(2)} SEO layouts.
          </p>

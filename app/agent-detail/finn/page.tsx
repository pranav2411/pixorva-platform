    ...
    <div className={`min-h-screen bg-white text-black ${inter.className} flex flex-col`}>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left space-y-6">
            ...
            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl" style={{ color: "rgba(255,255,255,0.95)" }}>
              &ldquo;I scan expense logs, audit payroll distributions, and optimize operational EBITDA structures.&rdquo;
            </p>
            ...
            <div className="bg-black/25 border-2 border-white p-4 rounded-2xl max-w-sm flex justify-between items-center text-white">
              <div>
                ...
                <span className="text-3xl font-black text-yellow-400">₹1,499/mo</span>
              </div>
            ...
            <div className="space-y-4 pt-4 max-w-md">
              ...
              >
                {loading ? 'Processing Transaction...' : '⚡ Hire FINN NOW'}
              </button>
            </div>
          </div>
      ...
      <section className="bg-white border-b-4 border-black py-10 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            ...
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">OVERHEAD OPTIMIZED</span>
          </div>
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            <span className={`text-4xl font-black text-black block ${oswald.className}`}>18%</span>
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">EBITDA MARGIN INCREASE</span>
          </div>
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            <span className={`text-4xl font-black text-black block ${oswald.className}`}>24/7</span>
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">LEDGER AUDITING</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b-4 border-black py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            {["Our operational costs are high and profit margins are shrinking.","Analyzing financial statements for cost leakages is manual.","We struggle to balance resource allocations against payroll."].map((pt, idx) => (
              <div 
                key={idx} 
      ...
      <section className="bg-white border-b-4 border-black py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium">
            Finn is your AI Finance Analyst, a tireless teammate who lives inside your workspace channels.
        ...
        <div className="max-w-5xl mx-auto space-y-20">
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Finn audits expense logs to identify leaks and suggest optimized payroll distribution parameters.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Expense leak audits</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Suggests cost saving paths</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Improves EBITDA margin index</span>
                    </li>
              ...
              <div className="w-full md:w-5/12">
                <div className="w-full bg-[#F1F5F9] border-4 border-black p-5 rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-black text-left">
            <h4 className="font-black text-xs uppercase text-slate-700 border-b-2 border-black pb-2 font-sans font-sans font-sans">EBITDA Scopes</h4>
            <div className="text-[10px] pt-3 leading-relaxed font-bold font-mono">
              ✓ Operational EBITDA raised +18%.<br />
              ✓ Payroll allocations balanced.
            </div>
          </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <h3 className={`text-3xl uppercase font-black leading-none ${oswald.className}`}>
                  EXPENSE SHEET SCANNING
                </h3>
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Finn scans digital bank ledgers to categorize costing parameters automatically, saving hours of manual Excel work.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Auto-checks ledger categories</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Scans monthly expense reports</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Identifies duplicate billing lines</span>
                    </li>
            ...
            <h4 className="font-black text-xs uppercase text-green-600 border-b-2 border-black pb-2">Ledger Result</h4>
            <div className="text-[10px] font-bold text-gray-500 pt-3 leading-relaxed">
              ✓ Cost ledger scanned (1,200 entries).<br />
              ✓ Duplicate SaaS subscriptions flagged: 3 entries.
            </div>
          </div>
              </div>
            </div>
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black text-center">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <p className="text-xs text-gray-500 font-bold uppercase max-w-xl mx-auto">
            Up and running in minutes. Finn handles the operational busywork so you can spend your day on what matters.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
              ...
              <p className="text-xs text-gray-500 font-medium leading-relaxed">
                Link Finn to your Slack, email, or repository in a couple of clicks. Setup is fully automated.
              </p>
            </div>
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
      ...
      <section className="bg-gray-50 py-16 px-6 border-b-4 border-black text-center">
        <div className="max-w-6xl mx-auto space-y-12">
          <h2 className={`text-3.5xl md:text-5xl uppercase font-black leading-none ${oswald.className}`}>
            Finn is praised by finance officers
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
              ...
              <div key={0} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                ...
                <h4 className="font-black text-xs uppercase text-black">&quot;Overhead expense saved&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Finn audited our payroll costing lines. ₹2.5M saved in operational overhead.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Warren Buffett, Investor</span>
              </div>
              ...
              <div key={1} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                <div className="flex items-center gap-1 text-yellow-400">★★★★★</div>
                <h4 className="font-black text-xs uppercase text-black">&quot;EBITDA margin increased&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Our EBITDA margin rose by 18%. Finn is a costing optimizer.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Ray Dalio, Fund Manager</span>
              </div>
              ...
              <div key={2} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                <div className="flex items-center gap-1 text-yellow-400">★★★★★</div>
                <h4 className="font-black text-xs uppercase text-black">&quot;Duplicate billing flagged&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Finn scans digital ledgers for duplicate subscriptions.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Sheryl Sandberg, Ex-Meta COO</span>
              </div>
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {[
              { q: "What exactly can Finn do?", a: "I scan expense logs, audit payroll distributions, and optimize operational EBITDA structures. She executes autonomous steps based on your triggers." },
      ...
      <section className="bg-gray-50 py-16 border-b-4 border-black text-center overflow-hidden">
        <div className="max-w-5xl mx-auto space-y-10 px-6">
          <h2 className={`text-3xl md:text-5xl uppercase font-black leading-none ${oswald.className}`}>
            Finn Loves to work with a team
          </h2>
        </div>
      ...
      <section className="bg-white py-16 px-6 text-center border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-8 border-4 border-black p-10 rounded-3xl bg-yellow-50 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
          ...
          <p className="text-lg md:text-xl font-bold text-gray-800 leading-snug relative z-10 max-w-xl mx-auto">
            Finn could have scanned {(seconds * 10).toFixed(0)} company cost line items, optimized ₹{(seconds * 350).toFixed(0)} of overhead expenses, and updated {(seconds * 0.025).toFixed(2)} EBITDA reports.
          </p>

    ...
    <div className={`min-h-screen bg-white text-black ${inter.className} flex flex-col`}>
      ...
      <header className="bg-white border-b-4 border-black px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <Link href="/employees" className="bg-black text-white p-2 rounded hover:bg-yellow-400 hover:text-black transition border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:shadow-none hover:translate-y-1 flex items-center justify-center shrink-0">
            <ArrowLeft size={16} />
          </Link>
          <h1 className={`text-2xl font-black uppercase tracking-wider ${oswald.className}`}>Agent Profile</h1>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left space-y-6">
            ...
            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl" style={{ color: "rgba(255,255,255,0.95)" }}>
              &ldquo;I structure agile sprint roadmaps, track board milestones, and log team action items.&rdquo;
            </p>
            ...
            <div className="bg-black/25 border-2 border-white p-4 rounded-2xl max-w-sm flex justify-between items-center text-white">
              <div>
                ...
                <span className="text-3xl font-black text-yellow-400">₹1,099/mo</span>
              </div>
            ...
            <div className="space-y-4 pt-4 max-w-md">
              ...
              >
                {loading ? 'Processing Transaction...' : '⚡ Hire PAT NOW'}
              </button>
            </div>
          </div>

          {/* Dedicated Right Hand Side Mockup */}
          <div className="w-full max-w-lg mx-auto bg-[#F4F4F5] border-4 border-black rounded-3xl overflow-hidden shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] text-black text-left p-4 font-sans">
      ...
      <section className="bg-white border-b-4 border-black py-10 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            <span className={`text-4xl font-black text-black block ${oswald.className}`}>45</span>
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">SPRINTS LAUNCHED</span>
          </div>
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            <span className={`text-4xl font-black text-black block ${oswald.className}`}>92%</span>
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">AGILE VELOCITY</span>
          </div>
          <div className="border-4 border-black p-6 rounded-2xl bg-yellow-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center space-y-1">
            <span className={`text-4xl font-black text-black block ${oswald.className}`}>8h</span>
            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest block">MEETING TIME SAVED</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b-4 border-black py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            {["Sprint planning and JIRA setup eats up our product timeline.","Action items from meetings are forgotten and tasks stall.","We lack clear roadmap specifications for developers."].map((pt, idx) => (
              <div 
                key={idx} 
      ...
      <section className="bg-white border-b-4 border-black py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium">
            Pat is your AI Product Manager, a tireless teammate who lives inside your workspace channels.
        ...
        <div className="max-w-5xl mx-auto space-y-20">
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <h3 className={`text-3xl uppercase font-black leading-none ${oswald.className}`}>
                  SCRUM SPRINT ROADMAPS
                </h3>
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Pat maps development velocity and sets up user stories in clean sprint modules, keeping developers unblocked.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Agile sprint setups</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Developer velocity checks</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Calculates team delivery indexes</span>
                    </li>
              ...
              <div className="w-full md:w-5/12">
                <div className="w-full bg-[#F4F4F5] border-4 border-black p-5 rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-black text-left">
            <h4 className="font-black text-xs uppercase text-teal-600 border-b-2 border-black pb-2">Sprint Velocity</h4>
            <div className="text-[10px] pt-3 leading-relaxed font-bold">
              ✓ Sprint roadmap configured (12 issues).<br />
              ✓ Target delivery timeline: 2 weeks.
            </div>
          </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  Pat writes structured markdown roadmap templates translating product concepts to JIRA tickets.
                </p>
                <ul className="space-y-2 pt-2">
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Markdown spec sheets</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Sprint action items logs</span>
                    </li>
                  
                    <li className="flex items-center gap-2 text-xs font-bold text-gray-700">
                      <CheckCircle size={14} className="text-green-600 shrink-0" />
                      <span>Prevents roadmap misunderstandings</span>
                    </li>
            ...
            <h4 className="font-black text-xs uppercase text-blue-600 border-b-2 border-black pb-2">Issue Details</h4>
            <div className="text-[10px] font-bold text-gray-500 pt-3 leading-relaxed">
              Ticket: Setup Supabase database tables.<br />
              ✓ Priority: High. Assigned to Ruby.
            </div>
          </div>
              </div>
            </div>
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black text-center">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <p className="text-xs text-gray-500 font-bold uppercase max-w-xl mx-auto">
            Up and running in minutes. Pat handles the operational busywork so you can spend your day on what matters.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
              ...
              <p className="text-xs text-gray-500 font-medium leading-relaxed">
                Link Pat to your Slack, email, or repository in a couple of clicks. Setup is fully automated.
              </p>
            </div>
            <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
      ...
      <section className="bg-gray-50 py-16 px-6 border-b-4 border-black text-center">
        <div className="max-w-6xl mx-auto space-y-12">
          <h2 className={`text-3.5xl md:text-5xl uppercase font-black leading-none ${oswald.className}`}>
            Pat is recommended by product leaders
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
              ...
              <div key={0} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                ...
                <h4 className="font-black text-xs uppercase text-black">&quot;Agile delivery index up&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Pat managed our sprint milestones. Developer velocity rose to 92%.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Jeff Sutherland, Scrum Co-Creator</span>
              </div>
              ...
              <div key={1} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                <div className="flex items-center gap-1 text-yellow-400">★★★★★</div>
                <h4 className="font-black text-xs uppercase text-black">&quot;Clean task descriptions&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Pat writes clean JIRA task specs. Developers have 0 confusion.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Ken Schwaber, Agile Expert</span>
              </div>
              ...
              <div key={2} className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-left space-y-4">
                <div className="flex items-center gap-1 text-yellow-400">★★★★★</div>
                <h4 className="font-black text-xs uppercase text-black">&quot;Project board structured&quot;</h4>
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  &quot;Sprint planning and milestone tracking are handled perfectly.&quot;
                </p>
                <span className="text-[10px] font-black text-gray-400 uppercase">— Marty Cagan, Product Author</span>
              </div>
      ...
      <section className="bg-white py-16 px-6 border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {[
              { q: "What exactly can Pat do?", a: "I structure agile sprint roadmaps, track board milestones, and log team action items. She executes autonomous steps based on your triggers." },
      ...
      <section className="bg-white py-16 px-6 text-center border-b-4 border-black">
        <div className="max-w-4xl mx-auto space-y-8 border-4 border-black p-10 rounded-3xl bg-yellow-50 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
          ...
          <p className="text-lg md:text-xl font-bold text-gray-800 leading-snug relative z-10 max-w-xl mx-auto">
            Pat could have drafted {(seconds * 0.025).toFixed(2)} sprint roadmap specifications, logged {(seconds * 0.1).toFixed(1)} action items, and updated {(seconds * 0.016).toFixed(3)} project JIRA boards.
          </p>

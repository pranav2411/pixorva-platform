        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left space-y-6">
            ...
            <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl" style={{ color: "rgba(255,255,255,0.95)" }}>
              &ldquo;${employee.name === 'Sam' ? 'I manage customer support tickets, answer help center queries, and audit customer SLA satisfaction scores.' : 'I draft viral Reels scripts, schedule Instagram postings, and compose engaging social media threads.'}&rdquo;
            </p>
          ...
          <div className="w-full max-w-lg mx-auto bg-gray-100 border-4 border-black rounded-3xl overflow-hidden shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] text-black relative min-h-[300px] p-4">
            ...
            <div className="absolute inset-x-6 top-1/2 -translate-y-1/2 bg-white border-4 border-black p-5 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center space-y-3 z-20">
              <div className="flex justify-center mb-1">
                <AgentAvatar id="mkt-2" className="w-12 h-12" />
              </div>
